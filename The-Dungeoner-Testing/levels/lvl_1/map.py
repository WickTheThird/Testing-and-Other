...
# NOTE: we need to completly rewrite the chest inter function (messed up id structure)
# I would say the following: add more items, potions etc. (add cunctionality to them)
# keep the current design in order to access those items 
# do chests last (as we need to rewrite the way that info is read to the files and edit how we read them)

# [1] -> availavle_ids
# [2] -> avalable_items
# [3] -> respective locations of items
# [4] -> coords of the items c
